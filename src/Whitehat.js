...
export default function Whitehat(props) {
    ...
    const mapGroupSelection = useMemo(() => {
        ...
        if (svg !== undefined & props.map !== undefined & props.data !== undefined) {
            ...
            const getEncodedFeature = d => Math.round((d.count / d.population) * 1000000);
            ...
            function getCount(name) {
                ...
                statePopulation = entry[0].population;
                stateDeaths = entry[0].count;
            ...
            const cityScale = d3.scaleLinear()
                .domain([0, cityMax])
                .range([0.75, maxRadius * maxRadius]);
            ...
            function drawLegend() {
                ...
                const barWidth = Math.min((width - legendX) / 3, 30);
                ...
                const legendTitle = {
                    'x': legendX - barWidth - 20,
                    'y': bounds.y + 125,
                    'text': 'Gun Deaths per 1,000,000 people'
                };
